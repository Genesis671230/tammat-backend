...
export const SERVICES = [
  {
    id: 'fine-reduction',
    title: 'Fine reduce mercy letter',
    shortTitle: 'Fine Reduce Mercy Letter',
    description: 'Reduce your visa overstay fine',
    longDescription: 'Reduce your uae fines, including overstay fine, travel ban fine, traffic fine, etc. by providing the required documents.',
    authority: 'ICP',
